namespace Fusion.Menu {
  ...
  /// The settings screen.
  /// </summary>
  public partial class PhotonMenuUISettings : PhotonMenuUIScreen {
    /// <summary>
    /// The ui app version dropdown.
    /// </summary>
    [InlineHelp, SerializeField] protected TMP_Dropdown _uiAppVersion;
    /// <summary>
    ...
    /// </summary>
    [InlineHelp, SerializeField] protected TMP_Dropdown _uiFramerate;
    /// <summary>
    /// The graphics quality dropdown.
    /// </summary>
    [InlineHelp, SerializeField] protected TMP_Dropdown _uiGraphicsQuality;
    /// <summary>
    /// The max player input field.
    /// </summary>
    [InlineHelp, SerializeField] protected TMP_InputField _uiMaxPlayers;
    /// <summary>
    /// The region dropdown.
    /// </summary>
    [InlineHelp, SerializeField] protected TMP_Dropdown _uiRegion;
    /// <summary>
    ...
    /// </summary>
    [InlineHelp, SerializeField] protected TMP_Dropdown _uiResolution;
    /// <summary>
    ...
    /// </summary>
    [InlineHelp, SerializeField] protected TMP_Text _sdkLabel;

    /// <summary>
    /// The region dropdown option map.
    /// </summary>
    protected PhotonMenuSettingsEntry<string> _entryRegion;
    /// <summary>
    /// The app version dropdown option map.
    /// </summary>
    protected PhotonMenuSettingsEntry<string> _entryAppVersion;
    /// <summary>
    /// The framerate dropdown option map.
    /// </summary>
    protected PhotonMenuSettingsEntry<int> _entryFramerate;
    /// <summary>
    /// The resolution dropdown option map.
    /// </summary>
    protected PhotonMenuSettingsEntry<int> _entryResolution;
    /// <summary>
    /// The graphics quality dropdown option map.
    /// </summary>
    protected PhotonMenuSettingsEntry<int> _entryGraphicsQuality;
    /// <summary>
    ...
    public override void Awake() {
      ...
      _entryRegion = new PhotonMenuSettingsEntry<string>(_uiRegion, SaveChanges);
      _entryAppVersion = new PhotonMenuSettingsEntry<string>(_uiAppVersion, SaveChanges);
      _entryFramerate = new PhotonMenuSettingsEntry<int>(_uiFramerate, SaveChanges);
      _entryResolution = new PhotonMenuSettingsEntry<int>(_uiResolution, SaveChanges);
      _entryGraphicsQuality = new PhotonMenuSettingsEntry<int>(_uiGraphicsQuality, SaveChanges);
      ...
      _graphicsSettings = new PhotonMenuGraphicsSettings();
    ...
    public override void Show() {
      ...
      _entryResolution.SetOptions(_graphicsSettings.CreateResolutionOptions, _graphicsSettings.Resolution, s => Screen.resolutions[s].ToString());
