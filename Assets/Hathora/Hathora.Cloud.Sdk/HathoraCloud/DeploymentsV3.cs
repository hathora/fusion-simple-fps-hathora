...
namespace HathoraCloud
{
    ...
    public class DeploymentsV3: IDeploymentsV3
    {
        ...
        public DeploymentsV3(ISpeakeasyHttpClient defaultClient, Func<Security>? securitySource, string serverUrl, SDKConfig config)
        {
        ...
        public async Task<CreateDeploymentResponse> CreateDeploymentAsync(CreateDeploymentRequest request)
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/deployments/v3/apps/{appId}/deployments", request);
            ...
            var serializedBody = RequestBodySerializer.Serialize(request, "DeploymentConfigV3", "json", false, false);
            ...
            if (httpCode == 201)
            {
                ...
                {                    
                    var obj = JsonConvert.DeserializeObject<DeploymentV3>(httpResponse.downloadHandler.text, new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = Utilities.GetDefaultJsonDeserializers() });
                    response.DeploymentV3 = obj;
                }
                else
                {
        ...
        public async Task<GetDeploymentResponse> GetDeploymentAsync(GetDeploymentRequest request)
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerDetails();
            var urlString = URLBuilder.Build(baseUrl, "/deployments/v3/apps/{appId}/deployments/{deploymentId}", request);
            ...
            int httpCode = errorCode ?? (int)httpResponse.responseCode;
            var response = new GetDeploymentResponse
            {
                StatusCode = httpCode,
                ContentType = contentType,
                RawResponse = httpResponse
        ...
        public async Task<GetDeploymentsResponse> GetDeploymentsAsync(GetDeploymentsRequest request)
        {
            ...
            if (httpCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json",response.ContentType))
                {                    
                    var obj = JsonConvert.DeserializeObject<DeploymentsV3Page>(httpResponse.downloadHandler.text, new JsonSerializerSettings(){ NullValueHandling = NullValueHandling.Ignore, Converters = Utilities.GetDefaultJsonDeserializers() });
                    response.DeploymentsV3Page = obj;
                }
                else
                {
                throw new SDKException("API error occurred", httpCode, httpResponse.downloadHandler.text, httpResponse);
        ...
        public async Task<GetLatestDeploymentResponse> GetLatestDeploymentAsync(GetLatestDeploymentRequest request)
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerDetails();
            var urlString = URLBuilder.Build(baseUrl, "/deployments/v3/apps/{appId}/deployments/latest", request);
